...
const en: Record<string, string> = {
  ...
  'Teste de Nível': 'Level Test',
  'Teste de Nível de Inglês': 'English Level Test',
  'Teste de Nivelamento': 'Proficiency Assessment',
  'Descubra Seu Verdadeiro Nível de Inglês': 'Discover Your True English Level',
  'Começar Avaliação Gratuita': 'Start Free Assessment',
  'Comece Sua Avaliação': 'Start Your Assessment',
  'Iniciar Teste': 'Start Test',
  'Teste de nível': 'Level test',
  'teste de inglês': 'english test',
  'teste de nível de inglês': 'english level test',
  'english level test': 'english level test',
  'teste de proficiência em inglês': 'english proficiency test',
  'avaliação de inglês online': 'online english assessment',
  'Avaliação gratuita': 'Free assessment',
  'Nível': 'Level',
  'Pontuação': 'Score',
  'Resultado': 'Result',
  'Questão': 'Question',
  ...
  'Intermediário Avançado': 'Upper Intermediate',
  'Avançado': 'Advanced',
  'Proficiente': 'Proficient',
  'Pontos Fortes': 'Strengths',
  'Áreas para Melhorar': 'Areas for Improvement',
  'Recomendação': 'Recommendation',
  'Compartilhar': 'Share',
  'Compartilhe seu resultado': 'Share your result',
  'Refazer Teste': 'Retake Test',
  'Ver Curso Recomendado': 'View Recommended Course',
  ...
  'Quer alcançar o próximo nível?': 'Want to reach the next level?',
  'Gerenciar Questões': 'Manage Questions',
  'Ver Resultados': 'View Results',
  'Total de Testes': 'Total Tests',
  'Testes Completos': 'Completed Tests',
  'Média Geral': 'Average Score',
  'Distribuição por Nível': 'Level Distribution',
