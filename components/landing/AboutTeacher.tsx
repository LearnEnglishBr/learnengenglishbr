          ...
          <FadeIn direction="right">
            <div>
              ...
              <div className="space-y-4 text-base text-muted-foreground leading-relaxed mb-10">
                {bio_paragraph_1 && <p><strong className="text-foreground">{name}</strong> {bio_paragraph_1}</p>}
                {bio_paragraph_2 && <p>{bio_paragraph_2}</p>}
                {bio_paragraph_3 && <p>{bio_paragraph_3}</p>}
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold mb-1">{info_box_1_title}</h4>
                    <p className="text-muted-foreground text-sm">{info_box_1_text}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold mb-1">{info_box_2_title}</h4>
                    <p className="text-muted-foreground text-sm">{info_box_2_text}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold mb-1">{info_box_3_title}</h4>
                    <p className="text-muted-foreground text-sm">{info_box_3_text}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <>
                  <AnimatePresence mode="wait">
                    <motion.img
                      ...
                      alt={`Professor ${name} — foto ${currentIndex + 1} de ${gallery_images.length}`}
